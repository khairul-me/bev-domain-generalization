...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='E:/bev_research/debug_pkls/nuscenes_val_1_legacy.pkl',
        bev_size=(
            200,
            200,
        ),
...
test_evaluator = dict(
    ann_file='E:/bev_research/debug_pkls/nuscenes_val_1_metric_with_gt.pkl',
    data_root='C:/datasets/nuscenes/',
    format_only=True,
    jsonfile_prefix='E:/bev_research/experiments/debug_yaw/format_only_gt',
    metric='bbox',
    type='NuScenesMetric')
test_pipeline = [
    dict(to_float32=True, type='LoadMultiViewImageFromFiles'),
...
work_dir = 'E:/bev_research/experiments/debug_yaw'
workflow = [
    (
        'train',
        1,
