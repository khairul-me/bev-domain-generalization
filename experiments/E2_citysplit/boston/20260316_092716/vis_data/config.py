...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='C:/datasets/nuscenes/nuscenes_infos_temporal_val_boston.pkl',
        bev_size=(
            200,
            200,
        ),
...
test_evaluator = dict(
    ann_file=
    'C:/datasets/nuscenes/nuscenes_infos_temporal_val_boston_metric.pkl',
    data_root='C:/datasets/nuscenes/',
    metric='bbox',
...
work_dir = 'E:/bev_research/experiments/E2_citysplit/boston'
workflow = [
    (
        'train',
        1,
