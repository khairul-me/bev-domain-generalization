...
default_hooks = dict(
    checkpoint=dict(interval=4, max_keep_ckpts=6, type='CheckpointHook'),
...
total_epochs = 24
train_cfg = dict(max_iters=120, type='IterBasedTrainLoop', val_interval=100000)
...
work_dir = 'E:/bev_research/experiments/E3_adapter/hook_probe'
workflow = [
    (
        'train',
        1,
