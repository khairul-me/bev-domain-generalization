...
custom_hooks = [
    dict(
        interval=50,
        log_path='E:/Auto_Image/debug-2a5848.log',
        run_id='stabilized-precheck',
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            depth_adapter=dict(lr_mult=0.001), img_backbone=dict(
                lr_mult=0.1))),
...
work_dir = 'E:/bev_research/experiments/E3_adapter/consistency_subset2k'
workflow = [
    (
        'train',
        1,
