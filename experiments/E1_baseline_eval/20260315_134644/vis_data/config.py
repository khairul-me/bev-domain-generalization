...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'C:/datasets/nuscenes/nuscenes_infos_temporal_val_datalist.pkl',
        bev_size=(
            200,
            200,
        ),
...
test_evaluator = dict(
    ann_file='C:/datasets/nuscenes/nuscenes_infos_temporal_val_datalist.pkl',
    data_root='C:/datasets/nuscenes/',
    metric='bbox',
    type='NuScenesMetric')
test_pipeline = [
...
work_dir = 'E:/bev_research/experiments/E1_baseline_eval'
workflow = [
    (
        'train',
        1,
