...
\caption{Layer-wise representation similarity.
  ...
  Method-consistent cosine distance ratios:
  \texttt{img\_feat} $1.098{\times}$ (95\,\%\,CI $[1.064,\ 1.135]$);
  \texttt{bev\_embed} $1.133{\times}$ (95\,\%\,CI $[1.101,\ 1.167]$); both $p{<}0.001$.
...
within-Boston cosine distance values were pooled ($n{=}750$), group labels
shuffled 10{,}000 times, and the fraction of permutations yielding a cross-minus-within
mean difference $\geq$ the observed $0.013$ was recorded; this fraction was $0$ in
both layers ($p < 0.001$).
